...
{
    XERCES_CPP_NAMESPACE::DOMElement * element = aDocument.createElement(L"dag");
...
void XmlDagWriter::Fill(XERCES_CPP_NAMESPACE::DOMDocument & aDocument, const XmlDag & aDag, XERCES_CPP_NAMESPACE::DOMElement & anElement)
{
  ...
  anElement.setAttribute(L"bonuspunten", Str::ToWString(aDag.Getbonuspunten()).c_str());
  anElement.setAttribute(L"datum", Str::ToWString(aDag.Getdatum()).c_str());
  anElement.setAttribute(L"gewicht", Str::ToWString(aDag.Getgewicht()).c_str());
}
