...
std::unique_ptr<XmlVoedingsmiddeldefs> XmlVoedingsmiddeldefsReader::Read(const std::string & aFilename)
{
    ...
    try
    {
        ...
        for (XMLSize_t i = 0; i < list->getLength(); i++)
        {
            ...
            {
                if (wcscmp(node->getNodeName(), L"voedingsmiddeldefs") == 0)
...
XmlClass::Result XmlVoedingsmiddeldefsReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlVoedingsmiddeldefs & aVoedingsmiddeldefs)
{
    ...
    for (XMLSize_t i = 0; i < list->getLength(); i++)
    {
        ...
        {
            if (wcscmp(node->getNodeName(), L"voedingsmiddeldef") == 0)
     {
