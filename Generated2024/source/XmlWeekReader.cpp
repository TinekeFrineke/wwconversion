...
XmlClass::Result XmlWeekReader::Fill(const XERCES_CPP_NAMESPACE::DOMNode & anElement, XmlWeek & aWeek)
{
    ...
    if (strategienode != nullptr)
    {
      ...
      else if (wcscmp(strategienode->getNodeValue(), L"Koolhydraten") == 0)
